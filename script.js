...
const NOTHING_CODES = arrayFromLowToHigh(0, 1);
...
let generatePassword = (characterAmount,includeUppercase,includeLowercase,includeNumbers,includeSymbols ) => {
	let charCodes = NOTHING_CODES;
